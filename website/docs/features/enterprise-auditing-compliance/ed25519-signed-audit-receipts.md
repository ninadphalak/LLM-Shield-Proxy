...
The proxy signs the canonical hash-chained form of every audit record with Ed25519. Given a separately trusted public key, an auditor can detect forged or altered records without possessing the private key.
