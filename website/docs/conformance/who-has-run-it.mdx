...
## One gateway passes: ours

**In 1.6.6, and only because we were quicker to fix what the check found. We wrote the check, so
hold us to it.** 1.6.0 leaked 6 of 32 and that row is still below. Find a case that trips us and
we will add it to the corpus and credit you.
