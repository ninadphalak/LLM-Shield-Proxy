...
To cite this project in academic research or technical publications before a formal DOI-backed release is published, cite the exact repository commit hash used for your evaluation and attach the corresponding conformance report checksum.
