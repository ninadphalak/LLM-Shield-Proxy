  ...
  return (
    <div className={styles.wrap}>
      ...
      <Lane
        ...
        last="Model provider"
        footnote="Nothing leaked, and your app is broken anyway: the caller gets a placeholder where its own data should be. The job calls this CHECK FAILED rather than a leak, because the fix is a different one. Set duty: anonymize if your product masks in one direction on purpose."
      />
    </div>
  );
}
