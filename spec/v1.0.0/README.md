...
The normative human-readable specification is published in `website/docs/conformance/specification-v1.md` and rendered on the project documentation site. `report.schema.json` defines the machine-readable report envelope.
