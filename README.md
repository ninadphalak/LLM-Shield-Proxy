...
# Output: {"status":"ok","service":"llm-shield-proxy","version":"1.2.13"}

$ curl -X GET "http://localhost:8000/readyz"
# Output: {"status":"ready","service":"llm-shield-proxy","version":"1.2.13","redis_connected":false}
...
Get-FileHash llm-shield-proxy-source-v1.2.13.zip -Algorithm SHA256
