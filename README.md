...
### A. Human-to-LLM (Text Prompts / STATELESS_SYNTHETIC)
...
4. **STATELESS_SYNTHETIC (Zero Storage):** (e.g. replacing *'My SSN is 000-00-0000'* with *'My SSN is [enc_3x9kL]'*). Encrypts PII in-band via AES-256-GCM. Zero Redis dependency.
