...
```bash
curl http://localhost:8000/healthz
# Output: {"status":"ok","service":"llm-shield-proxy","version":"1.0.17"}

curl http://localhost:8000/readyz
# Output: {"status":"ready","service":"llm-shield-proxy","version":"1.0.17","redis_connected":false}
...
Get-FileHash llm-shield-proxy-source-v1.0.17.zip -Algorithm SHA256
