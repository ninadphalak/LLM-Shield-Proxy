...
# Output: {"status":"ok","service":"llm-shield-proxy","version":"1.3.2"}

$ curl -X GET "http://localhost:8000/readyz"
# Output: {"status":"ready","service":"llm-shield-proxy","version":"1.3.2","redis_connected":false}
...
Get-FileHash llm-shield-proxy-source-v1.3.2.zip -Algorithm SHA256
