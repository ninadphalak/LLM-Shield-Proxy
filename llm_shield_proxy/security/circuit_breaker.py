...
def _evaluate_payload_duplicate(metrics: SessionMetrics, payload: dict, bounded_payload_str: str) -> None:
    """Executes CPU-bound entropy and SequenceMatcher difflib in a worker thread."""
...
async def check_circuit_breaker(session_id: str, payload: dict) -> None:
    ...
    await loop.run_in_executor(None, _evaluate_payload_duplicate, metrics, payload, bounded_payload_str)
