...
svg_content = """<svg width="900" height="450" viewBox="0 0 900 450" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <style>
      ...
      .vault-node { fill: #f8fafc; stroke: #64748b; stroke-width: 2; }
      ...
      @media (prefers-color-scheme: dark) {
        ...
        .vault-node { fill: #0f172a; stroke: #475569; }
  ...
  <!-- Changed stateful and stateless nodes to router-node class (standard) -->
  <rect x="420" y="70" width="200" height="36" class="router-node" rx="6" />
  <text x="520" y="93" text-anchor="middle" class="text">1. SYNTHETIC</text>

  <rect x="420" y="120" width="200" height="36" class="router-node" rx="6" />
  <text x="520" y="143" text-anchor="middle" class="text">2. STRUCTURAL_TAG</text>

  <rect x="420" y="170" width="200" height="36" class="router-node" rx="6" />
  <text x="520" y="193" text-anchor="middle" class="text">3. SCRUB</text>

  <rect x="420" y="220" width="200" height="36" class="router-node" rx="6" />
  ...
  <rect x="420" y="350" width="200" height="36" class="router-node" rx="6" />
  <text x="520" y="373" text-anchor="middle" class="text">STATELESS_SYNTHETIC</text>

  <!-- Redis (Cylinder) -->
  <g class="vault-node" transform="translate(710, 80)">
    <path d="M 0 15 L 0 65 A 65 15 0 0 0 130 65 L 130 15 Z" />
    <ellipse cx="65" cy="15" rx="65" ry="15" />
  </g>
  <text x="775" y="125" text-anchor="middle" class="text" style="font-weight:700;">Redis Vault</text>
