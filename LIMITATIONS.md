...
- Nothing binds a submitted conformance report to the run that produced it. The shipped
  fixture can also be passed by format-specific handling without a general detector. Both
